function atualizaValorTotal() {
  ...
  document.getElementById("quantidade-total").innerHTML = quantidadeTotal.toLocaleString('pt-BR');
  document.getElementById("valor-total").innerHTML = "R$ " + precoTotal.toLocaleString('pt-BR', {minimumFractionDigits: 2});
}
